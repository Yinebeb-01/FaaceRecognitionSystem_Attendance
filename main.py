...
path = 'create your own directory ...'
...
def TakeImages():
    ...
    if ((name.isalpha()) or (' ' in name)):
        ...
        parent_dir = "use your own directory /file path"
...
def TrainImages():
 #   path = 'C:/Users/Yinebeb/Desktop/face_detectionApp/FaceAttendanceSystem/Dataset'
    check_haarcascadefile()
    assure_path_exists("Trainer/")    # trianer
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            if (conf < 100):          # <50 ?
                ...
                namee = df.loc[df['SERIAL NO.'] == serial]['NAME'].values
                print(aa)    # fortest
                ...
                nam = str(namee)
                nam = bb[2:-2]
                attendance = [str(ID), '', nam, '', str(date), '', str(timeStamp)]
